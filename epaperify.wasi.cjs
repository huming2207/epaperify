...
let __wasmFilePath = __nodePath.join(__dirname, 'epaperify.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'epaperify.wasm32-wasi.debug.wasm')
